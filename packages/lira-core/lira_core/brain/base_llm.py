...
from lira_core.core.request_profiles import build_request_context
from lira_core.core.runtime_capabilities import get_provider_capabilities, resolve_llm_temperature
from lira_core.utils.terminal_ui import ui
    ...
    def gerar_resposta(
        ...
        try:
            ...
            if "401" in msg or "403" in msg or "invalid" in msg.lower() and "key" in msg.lower():
                return "💜 Chave de API inválida ou sem permissão. Confere o `.env`."
            if "timeout" in msg.lower() or "timed out" in msg.lower():
                return "💜 A API demorou demais. Manda de novo em alguns segundos."
            return "💜 Erro ao falar com a IA. Tenta de novo ou troca o provedor no config."
